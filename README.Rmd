...
```{r tern_pal, echo = FALSE, message=FALSE, warning=FALSE, fig.height=1, fig.width=7}
otp <- get_pal("tern")
print_pal(otp)
```
...
```{r ouR_team_pal, echo = FALSE, message=FALSE, warning=FALSE, fig.height=1, fig.width=7}
otp <- get_pal("ouR_team")
print_pal(otp)
```
...
```{r kingsbury_pal, echo = FALSE, message=FALSE, warning=FALSE, fig.height=1, fig.width=7}
kp <- get_pal("kingsbury")
print_pal(kp)
```
